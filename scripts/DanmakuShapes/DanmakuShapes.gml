...
function make_flower_danmaku(_x, _y, _n, _bullets_per_leaf, _dir_offset, _size, _layer, _obj){
    var _insts = [];
...
function make_shuriken_danmaku(_x, _y, _n, _bullets_per_line, _dir_offset, _size, _layer, _obj){
    var _insts = [];
    for(var _i = 0; _i < _n; _i++){
        var _start_dir = lerp(_dir_offset, _dir_offset + 360, _i / _n);
